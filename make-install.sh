...
function install()
{
    ...
    cp -- "./misc/${this_app_name}.desktop" "${dest_dir}/usr/share/applications/"
    cp -- "./misc/${this_app_name}.png" "${dest_dir}/usr/share/applications/hicolor/256x256/apps/${this_app_name}.png"
}
